...
it('ships a laravel boost guideline at the expected path', function () {
    ...
    expect($contents)
        ...
        ->toContain('docManager()')
        ->toContain('filterCollection()')
        ->toContain('filter_collections')
        ->toContain('schema()')
        ->toContain('doc_manager.get')
        ->toContain('one_off_quote.event.add')
        ->toContain('one_off_quote.get')
        ->toContain('org_role')
        ->toContain('event_branch')
        ->toContain('organization code')
        ->toContain('Shipment > DataContext > Branch')
        ->toContain('OrgRole')
