...
* Add one-off quote `quote_kpi` support on create via `quoteKpi()` and structured `quote_kpi`. This serializes as `Shipment > QuoteKPI > Code`; passing the KPI code alone is sufficient.
